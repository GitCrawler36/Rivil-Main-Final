/* ==========================================================================
   ...
   Accessibility / performance:
     - Slide 1 (NZ) loads eagerly via the baked-in inline background; every
       other image is preloaded ONE slide ahead, never all eight upfront.
...
(function () {
  ...
  var SLIDES = [
    ...
    { slug: 'ireland',     name: 'Ireland',         img: 'assets/destinations/ireland/hero-dublin-liffey.jpg',    page: 'study-ireland.html',     pill: 'Ireland' }
  ];
